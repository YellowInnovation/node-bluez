...
class Bluez extends EventEmitter {
    ...
    removeListeners() {
        this.objectManager.removeEventListener('InterfacesAdded', this.onInterfacesAdded.bind(this));
        this.objectManager.removeEventListener('InterfacesRemoved', this.onInterfaceRemoved.bind(this));
