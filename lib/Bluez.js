...
class Bluez extends EventEmitter {
    ...
    removeListeners() {
        this.objectManager.removeListener('InterfacesAdded', this.onInterfacesAdded.bind(this));
        this.objectManager.removeListener('InterfacesRemoved', this.onInterfaceRemoved.bind(this));
    }
